...
public class JGUIAssignment2 implements ActionListener {
	...
	private JButton btnClear;		// The clear buttons
	 ...
	 * @param buffer 
	 */
	public JGUIAssignment2(Writer writer, Reader reader){
		this.reader=reader;
		this.writer=writer;
	}
	...
	public void setlblRec(String c) {
		lblRec.setText(c);
	}
	
	public void setlistR(String c) {
		listR.setText(listR.getText()+ " newline " + c);
	}

	@Override
	public void actionPerformed(ActionEvent e) {
		System.out.println(txtTrans.getText());
		String transferString = txtTrans.getText();
		writer.write(transferString);
	}
}
